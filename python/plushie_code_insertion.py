...
path = os.path.realpath("minecraft_advanced_plushie_generator.py").replace(
    r"\python\minecraft_advanced_plushie_generator.py", r"")
...
def format_new_name(string):
    ...
    global proper_name
    return (string
            .replace("ALEXNOMPE", capital_name)
            .replace("alexnompe", lowercase_name)
            .replace("AlexNompe", proper_name))
...
def insert_plushie_into_the_game(name):
    ...
    capital_name = name.lower().swapcase()
    lowercase_name = name.lower()
    proper_name = name.lower().capitalize()
    ...
    with open(rf"{path}\src\client\java\net\plushified\PlushifiedClient.java",
              "r+") as file:
        check = format_new_name("""_plushie")));
		BlockEntityRendererFactories.register(ALEXNOMPE_PLUSHIE_BLOCK_ENTITY,
				context -> new PlushieRenderer(Identifier.of(Plushified.MOD_ID, "alexnompe_plushie"))); //this comment is autogenerated""")
        read = file.read()
    ...
    with open(rf"{path}\src\client\java\net\plushified\PlushifiedClient.java", "r+",
        ...
        check = format_new_name("""_PLUSHIE, RenderLayer.getTranslucent());
    	BlockRenderLayerMap.INSTANCE.putBlock(ALEXNOMPE_PLUSHIE, RenderLayer.getTranslucent()); //this comment is autogenerated""")
        read = file.read()
        if format_new_name(
    ...
    with open(
            ...
            "r+") as file:
        check = format_new_name("""plushie");
        translationBuilder.add(ALEXNOMPE_PLUSHIE, "AlexNompe plushie"); //this comment is autogenerated""")
        read = file.read()
    ...
    with open(
        ...
        check = format_new_name("""");
        translationBuilder.add(ALEXNOMPE_PLUSHIE, "Плюшевая игрушка AlexNompe"); //this comment is autogenerated""")
        read = file.read()
        if format_new_name("""translationBuilder.add(ALEXNOMPE_PLUSHIE,""") not in read:
    ...
    with open(
            ...
            "r+", encoding='utf-8') as file:
        check = format_new_name("""_PLUSHIE));
        addDrop(ALEXNOMPE_PLUSHIE, drops(ALEXNOMPE_PLUSHIE)); //this comment is autogenerated""")
        read = file.read()
    ...
    with open(rf"{path}\src\main\java\net\plushified\datagen\ModelGenerator.java", "r+",
              encoding='utf-8') as file:
        check = format_new_name("""_plushie")), Optional.empty()));
        itemModelGenerator.register(ALEXNOMPE_PLUSHIE.asItem(), new Model(Optional.of(Identifier.of(Plushified.MOD_ID,"block/alexnompe_plushie")), Optional.empty())); //this comment is autogenerated""")
        read = file.read()
        if format_new_name(
    ...
    with open(rf"{path}\src\main\java\net\plushified\registry\BlockEntityRegistry.java",
              "r+", encoding='utf-8') as file:
        check = format_new_name("""_PLUSHIE_BLOCK_ENTITY, pos, state);
        }
    }
    ...
    with open(rf"{path}\src\main\java\net\plushified\registry\BlockEntityRegistry.java",
              "r+", encoding='utf-8') as file:
        check = format_new_name("""_PLUSHIE).build();
    public static final BlockEntityType<AlexNompePlushieBlockEntity> ALEXNOMPE_PLUSHIE_BLOCK_ENTITY = BlockEntityType.Builder.create(AlexNompePlushieBlockEntity::new, ALEXNOMPE_PLUSHIE).build(); //this comment is autogenerated""")
        read = file.read()
    ...
    with open(rf"{path}\src\main\java\net\plushified\registry\BlockEntityRegistry.java",
              "r+", encoding='utf-8') as file:
        check = format_new_name("""_PLUSHIE_BLOCK_ENTITY);
        Registry.register(Registries.BLOCK_ENTITY_TYPE,
                Identifier.of(Plushified.MOD_ID, "alexnompe_plushie_block_entity"),
                ALEXNOMPE_PLUSHIE_BLOCK_ENTITY); //this comment is autogenerated""")
        read = file.read()
    ...
    with open(rf"{path}\src\main\java\net\plushified\registry\BlockRegistry.java", "r+",
              encoding='utf-8') as file:
        check = format_new_name("""PlushieBlockEntity::tick);
        }
    };
    ...
    with open(rf"{path}\src\main\java\net\plushified\registry\BlockRegistry.java", "r+",
              encoding='utf-8') as file:
        check = format_new_name("""_PLUSHIE/*array*/,ALEXNOMPE_PLUSHIE/*array*/}""")
        read = file.read()
        if format_new_name(
                """ALEXNOMPE_PLUSHIE/*array*/""") not in read:
            text = read.replace("""_PLUSHIE/*array*/}""", check, 1)
    if text != "":
        with open(rf"{path}\src\main\java\net\plushified\registry\BlockRegistry.java",
                  "w+", encoding='utf-8') as file:
            file.write(text)
    ...
    with open(rf"{path}\src\main\java\net\plushified\registry\BlockRegistry.java", "r+",
              encoding='utf-8') as file:
        check = format_new_name("""_PLUSHIE);
        RegisterBlockItem(Identifier.of(Plushified.MOD_ID, "alexnompe_plushie"), ALEXNOMPE_PLUSHIE); //this comment is autogenerated""")
        read = file.read()
        if format_new_name(
    ...
    with open(rf"{path}\src\main\java\net\plushified\registry\ItemGroupRegistry.java",
              ...
              encoding='utf-8') as file:
        check = format_new_name("""_PLUSHIE);
                entries.add(ALEXNOMPE_PLUSHIE); //this comment is autogenerated""")
        read = file.read()
        if format_new_name(
...
def remove_plushie(name):
    ...
    with open(rf"{path}\src\main\java\net\plushified\registry\BlockRegistry.java", "r+",
        ...
        read = file.read()
        if format_new_name(
                """ALEXNOMPE_PLUSHIE/*array*/""") in read:
            text = read.replace(check, """_PLUSHIE/*array*/}""", 1)
    if text != "":
        with open(rf"{path}\src\main\java\net\plushified\registry\BlockRegistry.java",
                  "w+", encoding='utf-8') as file:
            file.write(text)
...
def add_new_plushies(skin_path):
    ...
    if __name__ == "__main__":
        ...
        for r in pythonFiles:
            print(f"Checking {r}")
            if limit > 0 and not os.path.isfile((skin_path + "\\" + r).replace("_plushie", "")) and "_plushie" in str(
                    r):
