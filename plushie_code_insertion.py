...
def insert_plushie_into_the_game(name):
    ...
    text = ""
    with open(r"C:\MinecraftRelatedProjects\plushified\src\client\java\net\plushified\PlushifiedClient.java",
              "r+") as file:
        check = """_plushie")));
		BlockEntityRendererFactories.register(ALEXNOMPE_PLUSHIE_BLOCK_ENTITY,
            ...
            "ALEXNOMPE", capital_name).replace("alexnomoe", lowercase_name).replace("AlexNompe",
                                                                                    lowercase_name.capitalize())
        read = file.read()
    ...
    text = ""
    with open(r"C:\MinecraftRelatedProjects\plushified\src\main\java\net\plushified\datagen\BlockTagGenerator.java",
              "r+", encoding='utf-8') as file:
        check = """_PLUSHIE)
    ...
    contents = ""
    with open(
            r"C:\MinecraftRelatedProjects\plushified\src\main\resources\assets\plushified\geo\block\alexnompe_plushie.geo.json",
            "r+", encoding='utf-8') as file:
        contents = file.read()
    try:
        with open(
                rf"C:\MinecraftRelatedProjects\plushified\src\main\resources\assets\plushified\geo\block\{lowercase_name}_plushie.geo.json",
                "x") as f:
            f.write(contents)
            i = 1
    ...
    contents = ""
    with open(
            r"C:\MinecraftRelatedProjects\plushified\src\main\resources\assets\plushified\models\block\alexnompe_plushie.json",
            "r+", encoding='utf-8') as file:
        contents = file.read().replace("alexnompe", lowercase_name)
    try:
        with open(
                rf"C:\MinecraftRelatedProjects\plushified\src\main\resources\assets\plushified\models\block\{lowercase_name}_plushie.json",
                "x") as f:
            f.write(contents)
            i = 1
    except FileExistsError:
    ...
    contents = ""
    with open(
            r"C:\MinecraftRelatedProjects\plushified\src\main\resources\assets\plushified\models\custom\alexnompe_plushie.json",
            "r+", encoding='utf-8') as file:
        contents = file.read().replace("alexnompe", lowercase_name)
    try:
        with open(
                rf"C:\MinecraftRelatedProjects\plushified\src\main\resources\assets\plushified\models\custom\{lowercase_name}_plushie.json",
                "x") as f:
            f.write(contents)
            i = 1
    except FileExistsError:
...
def add_new_plushies(dir_path):
    if __name__ == "__main__":
        pythonFiles = [file for dirs in os.walk(dir_path, topdown=True)
                       for file in dirs[2]]
        for r in pythonFiles:
            print(f"Checking {r}")
            if limit > 0 and not os.path.isfile((dir_path + "\\" + r).replace("_plushie", "")) and "_plushie" in str(r):
                insert_plushie_into_the_game(r.replace(".png", "").replace("_plushie", ""))


def remove_old_plushies(dir_path):
    if __name__ == "__main__":
        pythonFiles = [file for dirs in os.walk(dir_path, topdown=True)
                       for file in dirs[2]]
