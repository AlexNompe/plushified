...
public class ItemGroupRegistry {
    private static final ItemGroup PLUSHIES_ITEMGROUP = FabricItemGroup.builder()
            ...
            .entries((context, entries) -> {
                ...
                entries.add(PEARLESCENTMOON_PLUSHIE);
                ...
                entries.add(RENDOG_PLUSHIE);
                entries.add(RESOTA_PLUSHIE);
                entries.add(ROSHAMBOGAMES_PLUSHIE);
                entries.add(SANHEZ_PLUSHIE);
                entries.add(SAPNAP_PLUSHIE);
                entries.add(SBseventhreeseven_PLUSHIE);
                entries.add(SECB_PLUSHIE);
                entries.add(SILLVIATV_PLUSHIE);
                entries.add(SIRPILIGRIM_PLUSHIE);
                entries.add(SKEPPY_PLUSHIE);
                entries.add(SKIZZLEMAN_PLUSHIE);
                entries.add(SLOVENOF_PLUSHIE);
                entries.add(SMALLISHBEANS_PLUSHIE);
                entries.add(SMMASSH_PLUSHIE);
                entries.add(SNEEGSNAG_PLUSHIE);
                entries.add(SNRGIRAFFE_PLUSHIE);
                entries.add(SPEPTICLE_PLUSHIE);
                entries.add(SPOKEISHERE_PLUSHIE);
                entries.add(SQUIDDO_PLUSHIE);
                entries.add(STALIN_PLUSHIE);
                entries.add(STRESSMONSTERonezeroone_PLUSHIE);
                entries.add(TALON_PLUSHIE);
                entries.add(TANGOTEK_PLUSHIE);
                entries.add(TECHNO_PLUSHIE);
                entries.add(THEKLYDE_PLUSHIE);
                entries.add(THETERRAIN_PLUSHIE);
                entries.add(TOMMYINNIT_PLUSHIE);
                entries.add(TUBBO_PLUSHIE);
                entries.add(TUVIKU_PLUSHIE);
                entries.add(VACMAKAC_PLUSHIE);
                entries.add(VENAZAR_PLUSHIE);
                entries.add(VERYLOUDER_PLUSHIE);
                entries.add(VIKKSTARonetwothree_PLUSHIE);
                entries.add(VINTAGEBEEF_PLUSHIE);
                entries.add(VIPSSS_PLUSHIE);
                entries.add(VMUTED_PLUSHIE);
                entries.add(VORTthreeXDRAGON_PLUSHIE);
                entries.add(WEMMBU_PLUSHIE);
                entries.add(WILBURSOOT_PLUSHIE);
                entries.add(WINSWEEP_PLUSHIE);
                entries.add(WOOGIEX_PLUSHIE);
                entries.add(XBCRAFTED_PLUSHIE);
                entries.add(XISUMA_PLUSHIE);
                entries.add(YAHIAMICE_PLUSHIE);
                entries.add(YEAH_JARON_PLUSHIE);
                entries.add(ZAKVIEL_PLUSHIE);
                entries.add(ZEDAPH_PLUSHIE);
                entries.add(ZMEEC_PLUSHIE);
                entries.add(ZMEEVIG_PLUSHIE);
                entries.add(ZOMBIECLEO_PLUSHIE);
                entries.add(_HEO__PLUSHIE); //this comment is autogenerated
            })
            .build();
