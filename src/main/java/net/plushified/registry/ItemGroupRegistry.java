...
public class ItemGroupRegistry {
    private static final ItemGroup PLUSHIES_ITEMGROUP = FabricItemGroup.builder()
            ...
            .entries((context, entries) -> {
                ...
                entries.add(eightONFIRE_PLUSHIE);
                ...
                entries.add(BDOUBLEOonezerozero_PLUSHIE);
                ...
                entries.add(CUBFANonethreefive_PLUSHIE);
                ...
                entries.add(DOCMsevenseven_PLUSHIE);
                entries.add(DOCTORfourT_PLUSHIE);
                entries.add(DOUBLEAzerosix_PLUSHIE);
                ...
                entries.add(FALSESYMMETRY_PLUSHIE);
                ...
                entries.add(KERALIS_PLUSHIE);
                entries.add(KETRINCYST_PLUSHIE);
                entries.add(KIRICATTUS_PLUSHIE);
                ...
                entries.add(MORIYASHIINE_PLUSHIE);
                entries.add(MRCUBEsix_PLUSHIE);
                entries.add(MRPUPE_PLUSHIE);
                entries.add(MUMBOJUMBO_PLUSHIE);
                ...
                entries.add(NOXINTRUS_PLUSHIE); //this comment is autogenerated
            })
            .build();
