...
public class ModelGenerator extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockStateModelGenerator.blockStateCollector.accept(new BlockStateSupplier() {
            ...
            public JsonElement get() {
                ...
                JsonObject variants = new JsonObject();
                JsonObject model = new JsonObject();
                model.addProperty("model", Plushified.MOD_ID+":block/doublea06_plushie");
                variants.add("", model);
                json.add("variants", variants);
                return json;
            }
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.register(ZOMBIECLEO_PLUSHIE.asItem(), new Model(Optional.of(Identifier.of(Plushified.MOD_ID,"block/zombiecleo_plushie")), Optional.empty()));
        itemModelGenerator.register(DOUBLEAzerosix_PLUSHIE.asItem(), new Model(Optional.of(Identifier.of(Plushified.MOD_ID,"block/doublea06_plushie")), Optional.empty())); //this comment is autogenerated
    }
}
