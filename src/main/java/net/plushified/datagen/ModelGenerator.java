...
public class ModelGenerator extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.register(ZMEEVIG_PLUSHIE.asItem(), new Model(Optional.of(Identifier.of(Plushified.MOD_ID,"block/zmeevig_plushie")), Optional.empty())); //this comment is autogenerated
    }
}
