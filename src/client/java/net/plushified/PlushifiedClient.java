...
public class PlushifiedClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
    	...
    	BlockRenderLayerMap.INSTANCE.putBlock(ZOMBIECLEO_PLUSHIE, RenderLayer.getTranslucent());
    	BlockRenderLayerMap.INSTANCE.putBlock(DOUBLEAzerosix_PLUSHIE, RenderLayer.getTranslucent()); //this comment is autogenerated
		...
		BlockEntityRendererFactories.register(ZOMBIECLEO_PLUSHIE_BLOCK_ENTITY,
				context -> new PlushieRenderer(Identifier.of(Plushified.MOD_ID, "zombiecleo_plushie")));
		BlockEntityRendererFactories.register(DOUBLEAzerosix_PLUSHIE_BLOCK_ENTITY,
				context -> new PlushieRenderer(Identifier.of(Plushified.MOD_ID, "doublea06_plushie"))); //this comment is autogenerated
	}
}