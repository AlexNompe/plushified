...
public class PlushifiedClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
    	...
    	BlockRenderLayerMap.INSTANCE.putBlock(ZMEEVIG_PLUSHIE, RenderLayer.getTranslucent()); //this comment is autogenerated
		...
		BlockEntityRendererFactories.register(ZMEEVIG_PLUSHIE_BLOCK_ENTITY,
				context -> new PlushieRenderer(Identifier.of(Plushified.MOD_ID, "zmeevig_plushie"))); //this comment is autogenerated
	}
}